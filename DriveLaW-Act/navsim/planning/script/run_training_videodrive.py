...
def navsim_genie_collate_fn(
    ...
    Expected features:
      ...
      - status_feature: [...], with status_feature[0] = speed (m/s), [1] = acc (m/s^2)
      - last_hidden_state: (L, D) optional
    Expected targets:
      - trajectory: (L, action_dim) used as action supervision (if return_action)
    """
...
class UnifiedTrainer:
    ...
    - Model/training loop: reuses existing diffusion training logic (video/action branches, flow matching, accelerate)
