...
torchrun --nproc_per_node=$RESOURCE_GPU \
    ...
    $NAVSIM_DEVKIT_ROOT/navsim/agents/videodrive/run_training_videodrive_stage2.py \
    agent=videodrive_agent \
    agent.config_file="/path/to/navsim/agents/videodrive/configs/ltx_model/video_model_infer_navsim_stage2.yaml" \
